...
<template>
  <div class="assets-wrap">
    ...
    <div class="content">
        ...
        <el-form label-position="right" label-width="80px" :model="searchMap">
          ...
          <el-col :span="4">
            <el-form-item label="起点桩号">
              <el-select v-model="searchMap.T0002_START_PILE" style="width:100%" size="small">
                <el-option
          ...
          <el-col :span="4">
            <el-form-item label="关键字">
              <el-input placeholder="请输入关键字" v-model="searchMap.SEARCH_KEY" size="small"></el-input>
            </el-form-item>
          </el-col>
      ...
      <div class="div-btn">
        ...
        <div style="float:right;">
          ...
          >待检查 {{huizong.allSum-huizong.exitCheck}}
          </el-button>
          <el-button
            type="primary"
            size="small"
    ...
    >
      <div style="height:600px">
        <el-form :label-position="labelPosition" label-width="100px" :model="infoForm">
          <table class="add-table">
            <tr>
              <td class="bg-td">资产名称：</td>
              <td>
